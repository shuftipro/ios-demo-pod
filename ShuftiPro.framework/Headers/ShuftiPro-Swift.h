...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified dummyProcessingView;
...
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified topconstraintZoomImage;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidDisappear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
...
SWIFT_CLASS("_TtC9ShuftiPro23ZoomImageViewController")
...
@interface ZoomImageViewController (SWIFT_EXTENSION(ShuftiPro))
